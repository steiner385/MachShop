...
export class SelectionManager {
   ...
   */
  addToSelection(annotationId: string, keepPrimary: boolean = true): void {
    this.state.selectedIds.add(annotationId);
    if (!keepPrimary || !this.state.primaryId) {
      this.state.primaryId = annotationId;
    }
  }
   ...
   */
  toggleSelection(annotationId: string, keepOthers: boolean = true): void {
    if (this.state.selectedIds.has(annotationId)) {
      ...
      this.addToSelection(annotationId, true);
    }
  }
