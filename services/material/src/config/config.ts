...
const envSchema = Joi.object({
  ...
  SERVICE_NAME: Joi.string()
    .default('material-service'),

  // Database Configuration
  MATERIAL_DATABASE_URL: Joi.string()
    .required()
  ...
  KAFKA_GROUP_ID: Joi.string()
    .default('material-service-group'),
  ...
  // Business Rules
  MAX_MATERIAL_QUANTITY: Joi.number()
    .default(10000)
...
export const config = {
  ...
  // Database
  database: {
    url: envVars.MATERIAL_DATABASE_URL as string,
  },
  ...
  // Business Rules
  businessRules: {
    maxWorkOrderQuantity: envVars.MAX_MATERIAL_QUANTITY as number,
