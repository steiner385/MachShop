 ...
 *
 * Port: 3012
 * Database: postgres-traceability (port 5433)
 */
...
import traceabilityRoutes from './routes/workOrders';
...
// Work Order routes
app.use('/api/v1/traceability', writeLimiter, traceabilityRoutes);
...
const server = app.listen(PORT, () => {
  ...
  console.log(`📊 API endpoint: http://localhost:${PORT}/api/v1/traceability`);
  console.log('='.repeat(60));
});
