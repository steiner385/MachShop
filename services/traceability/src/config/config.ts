...
const envSchema = Joi.object({
  ...
  SERVICE_NAME: Joi.string()
    .default('traceability-service'),

  // Database Configuration
  TRACEABILITY_DATABASE_URL: Joi.string()
    .required()
  ...
  KAFKA_GROUP_ID: Joi.string()
    .default('traceability-service-group'),
  ...
  // Business Rules
  MAX_TRACEABILITY_QUANTITY: Joi.number()
    .default(10000)
...
export const config = {
  ...
  // Database
  database: {
    url: envVars.TRACEABILITY_DATABASE_URL as string,
  },
  ...
  // Business Rules
  businessRules: {
    maxWorkOrderQuantity: envVars.MAX_TRACEABILITY_QUANTITY as number,
