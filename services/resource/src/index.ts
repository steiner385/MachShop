 ...
 *
 * Port: 3013
 * Database: postgres-resource (port 5433)
 */
...
import resourceRoutes from './routes/workOrders';
...
// Work Order routes
app.use('/api/v1/resource', writeLimiter, resourceRoutes);
...
const server = app.listen(PORT, () => {
  ...
  console.log(`📊 API endpoint: http://localhost:${PORT}/api/v1/resource`);
  console.log('='.repeat(60));
});
