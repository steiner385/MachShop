...
const envSchema = Joi.object({
  ...
  REPORTING_DATABASE_URL: Joi.string()
    .required()
  ...
  KAFKA_GROUP_ID: Joi.string()
    .default('reporting-service-group'),
  ...
  // Business Rules
  MAX_REPORTING_QUANTITY: Joi.number()
    .default(10000)
...
export const config = {
  ...
  // Database
  database: {
    url: envVars.REPORTING_DATABASE_URL as string,
  },
  ...
  // Business Rules
  businessRules: {
    maxWorkOrderQuantity: envVars.MAX_REPORTING_QUANTITY as number,
