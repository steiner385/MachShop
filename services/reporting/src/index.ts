 ...
 *
 * Port: 3014
 * Database: postgres-reporting (port 5433)
 */
...
import reportingRoutes from './routes/workOrders';
...
// Work Order routes
app.use('/api/v1/reporting', writeLimiter, reportingRoutes);
...
const server = app.listen(PORT, () => {
  ...
  console.log(`📊 API endpoint: http://localhost:${PORT}/api/v1/reporting`);
  console.log('='.repeat(60));
});
