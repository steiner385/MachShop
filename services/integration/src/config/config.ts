...
const envSchema = Joi.object({
  ...
  INTEGRATION_DATABASE_URL: Joi.string()
    .required()
  ...
  KAFKA_GROUP_ID: Joi.string()
    .default('integration-service-group'),
  ...
  // Business Rules
  MAX_INTEGRATION_QUANTITY: Joi.number()
    .default(10000)
...
export const config = {
  ...
  // Database
  database: {
    url: envVars.INTEGRATION_DATABASE_URL as string,
  },
  ...
  // Business Rules
  businessRules: {
    maxWorkOrderQuantity: envVars.MAX_INTEGRATION_QUANTITY as number,
