...
const envSchema = Joi.object({
  ...
  QUALITY_DATABASE_URL: Joi.string()
    .required()
  ...
  // Business Rules
  MAX_QUALITY_QUANTITY: Joi.number()
    .default(10000)
...
export const config = {
  ...
  // Database
  database: {
    url: envVars.QUALITY_DATABASE_URL as string,
  },
  ...
  // Business Rules
  businessRules: {
    maxWorkOrderQuantity: envVars.MAX_QUALITY_QUANTITY as number,
