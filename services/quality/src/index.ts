 ...
 *
 * Port: 3010
 * Database: postgres-quality (port 5433)
 */
...
import qualityRoutes from './routes/workOrders';
...
// Work Order routes
app.use('/api/v1/quality', writeLimiter, qualityRoutes);
...
const server = app.listen(PORT, () => {
  ...
  console.log(`📊 API endpoint: http://localhost:${PORT}/api/v1/quality`);
  console.log('='.repeat(60));
});
