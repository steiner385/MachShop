...
const envSchema = Joi.object({
  ...
  WORK_ORDER_DATABASE_URL: Joi.string()
    .required()
  ...
  KAFKA_GROUP_ID: Joi.string()
    .default('work-order-service-group'),
  ...
  // Business Rules
  MAX_WORK_ORDER_QUANTITY: Joi.number()
    .default(10000)
...
export const config = {
  ...
  // Database
  database: {
    url: envVars.WORK_ORDER_DATABASE_URL as string,
  },
  ...
  // Business Rules
  businessRules: {
    maxWorkOrderQuantity: envVars.MAX_WORK_ORDER_QUANTITY as number,
